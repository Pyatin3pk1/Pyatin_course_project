                ...
                <div class="row add-records">
                    <form action="create.php" method="post">
                         ...
                         <label for="content" class="form-label">ID_Employee</label>
                              <input type="text" name="ID_Employee" class="form-control" aria-label="Введите имя сотрудника">
                         </div>
                         <div class="col">
                              <label for="content" class="form-label">Заголовок</label>
                              <input type="text" value="<?=$Title?>"name="Title" class="form-control" id="content" placeholder="Введите кабинет для записи">
                         </div>
                         <div class="col">
